...
public static class UIGroupPrefabExtension
{
	...
	{
		Entity entity2 = ExtraLib.m_PrefabSystem.GetEntity(uIGroupPrefab);
		ExtraLib.m_EntityManager.GetBuffer<UIGroupElement>(entity2).Add(new UIGroupElement(entity));
		ExtraLib.m_EntityManager.GetBuffer<UnlockRequirement>(entity2).Add(new UnlockRequirement(entity, UnlockFlags.RequireAny));
	}
