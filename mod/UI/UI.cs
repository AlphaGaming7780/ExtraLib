...
namespace ExtraDetailingTools.UI
{

    public partial class ELT_UI : UISystemBase
    {
        ...
        protected override void OnCreate()
        {
            ...
            base.OnCreate();
            ELT.m_RenderingSystem = World.GetOrCreateSystemManaged<RenderingSystem>();
            ELT.m_ToolSystem = World.GetOrCreateSystemManaged<ToolSystem>();
            ELT.m_ToolbarUISystem = World.GetOrCreateSystemManaged<ToolbarUISystem>();
            // ELT.m_ToolUISystem = base.World.GetOrCreateSystemManaged<ToolUISystem>();
            ELT.m_SurfaceReplacerTool = World.GetOrCreateSystemManaged<SurfaceReplacerTool>();
        ...
        public static void RemoveEntityObjectFromCategoryUI(Entity entity)
        {
            ...
            {
                ELT.Logger.Error($"Could not get the buffer for RemoveEntityObjectFromCategoryUI");
                return;
            };
        ...
        public static void AddEntityObjectToCategoryUI(Entity entity)
        {
            ...
            if (!ELT.m_EntityManager.TryGetBuffer(uIObjectData.m_Group, false, out DynamicBuffer<UIGroupElement> uiGroupBuffer))
            {
                ELT.Logger.Error($"Could not get the buffer for AddEntityObjectToCategoryUI");
                return;
            };
        ...
        public static void RemoveEntityCategoryUiFromMenuUI(Entity entity)
        {
            ...
            {
                ELT.Logger.Error($"Could not get the buffer for RemoveEntityCategoryUiFromMenuUI");
                return;
            };
        ...
        public static void AddEntityCategoryUiToMenuUI(Entity entity)
        {
            ...
            if (!ELT.m_EntityManager.TryGetBuffer(uIAssetCategoryData.m_Menu, false, out DynamicBuffer<UIGroupElement> uiGroupBuffer))
            {
                ELT.Logger.Error($"Could not get the buffer for AddEntityCategoryUiToMenuUI");
                return;
            };
        ...
        internal static void SetUpMarker(PrefabBase prefabBase)
        {
            ...
            if(ELT.m_PrefabSystem is null) {
                ELT.Logger.Error("Prefab system is null");
            }
